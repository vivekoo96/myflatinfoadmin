                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6 col-md-8">
                      ...
                      @forelse($roles as $role)
                            ...
                            @if($role->name !== 'User' && $role->type !== "issue")
                                <a href="/select-role/{{ $role->id }}" style="text-decoration: none;">
                                    <div class="role-card">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="text-left">
                                                <h5 class="mb-1" style="color: #fff;">{{ $role->name }}</h5>
                                                <small class="text-muted">
                                                    {{ $role->description ?? 'Click to select' }}
                                                </small>
                                            </div>
