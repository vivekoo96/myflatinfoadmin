                    ...
                    <form class="form-horizontal" action="{{url('update-profile')}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" id="inputFirstName" name="first_name" placeholder="First Name" value="{{$customer->first_name}}" minlength="3" maxlength="20"
                        ...
                        <div class="col-sm-6">
                          ...
                          <input type="text" class="form-control" id="inputLastName" name="last_name" placeholder="Last Name" value="{{$customer->last_name}}" minlength="3" maxlength="20"
                          onkeypress="return event.charCode >= 65 && event.charCode <= 90 || event.charCode >= 97 && event.charCode <= 122 || event.charCode == 32" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" name="email" placeholder="Email" value="{{$customer->email}}" maxlength="50" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputName2" class="col-sm-2 col-form-label">Phone</label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="phone" placeholder="Phone" value="{{$customer->phone}}" minlength="10" maxlength="10"  
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea name="address" class="form-control" minlength="1" placeholder="Address" maxlength="100" required>{{$customer->address}}</textarea>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputSkills" class="col-sm-2 col-form-label">Profile Image (max 2 mb)
                            <img src="{{$customer->photo}}" class="profile-preview-img">
                        </label>
                        <div class="col-sm-10">
