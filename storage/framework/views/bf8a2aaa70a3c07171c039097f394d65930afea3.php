...
<?php $__env->startSection('title'); ?>
    <?php echo e($role->slug == 'president' ? 'President' : $role->name); ?> List
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1><?php echo e($role->slug == 'president' ? 'President' : $role->name); ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active"><?php echo e($role->slug == 'president' ? 'President' : $role->name); ?></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
               <?php 
                ...
                <!--<button class="btn btn-sm btn-success right mr-2" data-toggle="modal" data-target="#addUserModal" <?php echo e($created_counts >= $login_limit ? 'disabled' : ''); ?>>Add New User</button>-->
                 <?php if(Auth::User()->role == 'BA' || Auth::user()->selectedRole->name == "Issue Tracker"): ?>
                <button class="btn btn-sm btn-success right mr-2" data-toggle="modal" data-target="#addUserModal" <?php echo e($created_counts >= $login_limit ? 'disabled' : ''); ?>>Add New <?php echo e($role->slug == 'president' ? 'President' : $role->name); ?></button>
                 <button class="btn btn-sm btn-success right mr-2" data-toggle="modal" data-target="#addModal" <?php echo e($created_counts >= $login_limit ? 'disabled' : ''); ?>>Add <?php echo e($role->slug == 'president' ? 'President' : $role->name); ?> By Email</button>
                <?php endif; ?>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <?php $i++; ?>
                  <tr data-building_user_id="<?php echo e($item->id); ?>" data-user_id="<?php echo e($item->user->id); ?>">
                    <td><?php echo e($i); ?></td>
                    <td>
                      
                      <?php if($item->user->photo): ?>
                        <img src="<?php echo e($item->user->photo); ?>" alt="Profile" class="img-thumbnail" style="width: 50px; height: 50px; object-fit: cover;">
                      <?php else: ?>
                    ...
                    <td><?php echo e($item->user->city ? $item->user->city->name : 'N/A'); ?></td>
                    <td>
                      <span class="text-truncate" style="max-width: 150px; display: inline-block;" title="<?php echo e($item->user->address ?? 'N/A'); ?>">
                        <?php echo e($item->user->address ?? 'N/A'); ?>

                      </span>
                    </td>
                    <td>
                      <span class="badge badge-<?php echo e($item->status == 'Active' ? 'success' : 'danger'); ?>">
                    ...
                    <td>
                      ...
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" 
                              ...
                              data-user_name="<?php echo e($item->user->name); ?>" 
                              data-first_name="<?php echo e($item->user->first_name ?? 'No First Name'); ?>" 
                              data-last_name="<?php echo e($item->user->last_name ?? 'No Last Name'); ?>" 
                              data-user_email="<?php echo e($item->user->email); ?>" 
                              data-user_id="<?php echo e($item->user->id); ?>"
                              data-building_user_id="<?php echo e($item->id); ?>"
                              data-phone="<?php echo e($item->user->phone); ?>"
                              data-gender="<?php echo e($item->user->gender); ?>"
                              data-city_id="<?php echo e($item->user->city_id); ?>"
                              data-address="<?php echo e($item->user->address); ?>"
                              data-company="<?php echo e($item->user->company_name); ?>"
                              data-status="<?php echo e($item->status ?? 'Active'); ?>"
                              data-image="<?php echo e($item->user->photo); ?>"
                              title="Edit <?php echo e($role->slug == 'president' ? 'President' : $role->name); ?>">
                        <i class="fa fa-edit"></i>
                      </button>
                      <?php if($item->deleted_at): ?>
                      <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo e($item->id); ?>" data-building_user_id="<?php echo e($item->id); ?>" data-action="restore"><i class="fa fa-undo"></i></button>
                      <?php else: ?>
                      <button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo e($item->id); ?>" data-building_user_id="<?php echo e($item->id); ?>" data-action="delete"><i class="fa fa-trash"></i></button>
                      <?php endif; ?>
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo e(url('store-user')); ?>" method="post" class="add-user-form" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div class="modal-body">
          ...
          <input type="hidden" name="role_id" id="role-id" value="<?php echo e($role->id); ?>">
        </div>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add New <?php echo e($role->slug == 'president' ? 'President' : $role->name); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <form action="<?php echo e(url('store-user-role')); ?>" method="post" class="add-form" enctype="multipart/form-data" id="user-role-form">
        <?php echo csrf_field(); ?>
        <div class="modal-body">
          <div class="error"></div>
          <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    $('#addModal').on('show.bs.modal', function (event) {
      var role = "<?php echo e($role->slug == 'president' ? 'President' : $role->name); ?>";
      var button = $(event.relatedTarget);
      ...
      $('#user-role-form').attr('action', '<?php echo e(url("store-user-role")); ?>');
      
      if(edit_id){
          // Editing existing user - populate fields and change form action
          $('.modal-title').text('Update ' + role);
          $('#user-role-form').attr('action', '<?php echo e(url("update-user-role")); ?>');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/role/department.blade.php ENDPATH**/ ?>