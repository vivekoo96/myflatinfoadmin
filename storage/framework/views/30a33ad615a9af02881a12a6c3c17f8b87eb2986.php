      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="card">
                <div class="card-body">
                  <form method="GET" action="<?php echo e(url('account/maintenance/manage')); ?>">
                    <div class="form-row">
                       <div class="form-group col-md-6">
                        <label for="block" class="col-form-label">Block:</label>
                        <select name="block" id="block" class="form-control">
                          <option value="" <?php echo e(request('block') == '' ? 'selected' : ''); ?>>All</option>
                          ...
                          <option value="<?php echo e($block->id); ?>" <?php echo e(request('block') == $block->id ? 'selected' : ''); ?>><?php echo e($block->name); ?></option>
              ...
              <div class="card-header p-2">
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <small class="text-muted">Total records: <?php echo e($maintenance_payments->count()); ?></small>
                  </div>
                  <div class="col-md-6">
        ...
        return $grand_total;
              ...
              <div class="card-body">
                    ...
                    <table id="maintenanceTable" class="maintenance-table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php $i = 0;?>
                        <?php $__empty_1 = true; $__currentLoopData = $maintenance_payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $i++; ?>
                        <tr>
                          <td><?php echo e($i); ?></td>
...
<td>
  ...
  ?>
  <?php if($living === 'tanent' || $living === 'tenant'): ?>
    Tenant
  <?php else: ?>
    <?php echo e($payment->flat->living_status); ?>

  <?php endif; ?>
</td>
                          <td><?php echo e($payment->flat->owner ? $payment->flat->owner->name : '-'); ?></td>
                          <td><?php echo e($payment->flat->tanent ? $payment->flat->tanent->name : '-'); ?></td>
                          ...
                          <td><?php echo e($payment->maintenance->due_date); ?></td>
                            <td><?php echo e($payment->maintenance->gst); ?></td>
  ...
  ?>
                          ...
                          <td>
                            ...
                            <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#paymentModal" 
                                    onclick="setPaymentData('<?php echo e($payment->id); ?>', '<?php echo e($payment->flat->owner ? $payment->flat->owner->name : ''); ?>', '<?php echo e($payment->flat->tanent ? $payment->flat->tanent->name : ''); ?>', '<?php echo e($payment->flat_id); ?>')">
                                Pay Now
                            </button>
                            <?php endif; ?>
                            <?php else: ?>
                            <a href="<?php echo e(url('account/maintenance/reciept',$payment->id)); ?>" class="btn btn-sm btn-info">Reciept</a>
                            <a href="<?php echo e(url('account/maintenance/invoice',$payment->id)); ?>" class="btn btn-sm btn-warning">Invoice</a>
                            <?php endif; ?>
                          </td>
                        </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('change','#block',function(){
      var block = $(this).val();
      var url = "<?php echo e(url('/get-flats')); ?>";
      $('#flat_id').html('<option value="">Select Flat</option>');
        $.ajax({
          url : "<?php echo e(url('/get-flat-data')); ?>",
          type: "post",
    ...
    var block = $('#block').val();
    var flat_id = "<?php echo e(request('flat_id')); ?>";
    $.ajax({
          url : "<?php echo e(url('/get-flat-data')); ?>",
          type: "post",
    ...
    $('#clearFilter').on('click', function() {
        ...
        window.location.href = "<?php echo e(url('account/maintenance/manage')); ?>";
    });
    ...
    window.proceedPayment = function() {
        ...
        var url = "<?php echo e(url('account/maintenance/pay')); ?>/" + flatId + "?payment_person=" + paymentPerson;
...
if (typeof window.proceedPayment !== 'function') {
  window.proceedPayment = function() {
    try {
      ...
      var url = (function(){
        var base = "<?php echo e(url('account/maintenance/pay')); ?>";
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/account/maintenance/manage_maintenance.blade.php ENDPATH**/ ?>