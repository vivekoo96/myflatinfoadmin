...
<body>
    ...
    <div class="content">
        ...
        <div class="otp-code">
            ...
            <div class="otp-number"><?php echo e($otp); ?></div>
    ...
    <div class="footer">
        ...
        <p>&copy; <?php echo e(date('Y')); ?> Building Admin System. All rights reserved.</p>
    </div>
</body>
</html>
<?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/email/forget_password_otp.blade.php ENDPATH**/ ?>