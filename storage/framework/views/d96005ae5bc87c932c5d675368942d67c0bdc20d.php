              ...
              <div class="card-body">
                ...
                <div class="row mb-3">
                  <div class="col-md-3">
                    ...
                    <select id="blockFilter" class="form-control">
                      ...
                      <?php $__empty_1 = true; $__currentLoopData = $building->blocks()->where('status','Active')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                      <option value="<?php echo e($block->name); ?>"><?php echo e($block->name); ?></option>
                ...
                <table id="gatesTable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo e(route('gate.show',$gate->id)); ?>"   class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>
                       <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'security')): ?>
  ...
  $(document).ready(function(){
    ...
    $('.status').bootstrapSwitch('state');
        $('.status').on('switchChange.bootstrapSwitch',function () {
            var id = $(this).data('id');
            $.ajax({
                url : "<?php echo e(url('update-gate-status')); ?>",
                type: "post",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/gate/index.blade.php ENDPATH**/ ?>