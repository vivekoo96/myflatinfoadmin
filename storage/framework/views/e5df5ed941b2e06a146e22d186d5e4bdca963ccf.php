              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                       <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'Accounts') || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'President') ): ?>
                      ...
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($essential->id); ?>" data-reason="<?php echo e($essential->reason); ?>"
                       data-building_id="<?php echo e($essential->building_id); ?>" data-amount="<?php echo e($essential->amount); ?>" data-due_date="<?php echo e($essential->due_date); ?>" data-late_fine_type="<?php echo e($essential->late_fine_type); ?>"
                       data-late_fine_value="<?php echo e($essential->late_fine_value); ?>" data-status="<?php echo e($essential->status); ?>" data-gst="<?php echo e($essential->gst); ?>" data-actived_by="<?php echo e($essential->actived_by); ?>"><i class="fa fa-edit"></i></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/essential/index.blade.php ENDPATH**/ ?>