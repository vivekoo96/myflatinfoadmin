...
<div style="max-width:600px; background:#ffffff; padding:20px; border-radius:10px;
    ...
    <!-- Logo -->
    <img src="<?php echo e($logo); ?>" alt="MyFlatInfo" style="width:160px; display:block; margin:0 auto;">
    
    <h1 style="color:#333;">Hello <?php echo e($user->name); ?></h1>
   

    <h2 style="color:#333;">Your password for login in <strong>MyFlatInfo</strong> is</h2>
     <h1 style="color:#2d89ef; font-size:32px; margin-top:10px;"><?php echo e($user->email); ?></h1>
...
<?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/email/password.blade.php ENDPATH**/ ?>