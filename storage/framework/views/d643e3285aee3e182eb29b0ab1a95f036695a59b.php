          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <?php if(Auth::User()->role == 'BA' || Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'Security'): ?>
                <button class="btn btn-sm btn-success right mr-2" data-toggle="modal" data-target="#addUserModal" <?php echo e($created_counts >= $login_limit ? 'disabled' : ''); ?>>Add New Guard</button>
                <?php endif; ?>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $i = 0; ?>
                  <?php $__empty_1 = true; $__currentLoopData = $guardsData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php $i++; $bu = $entry->building_user; $guard = $entry->guard; ?>
                  <tr>
                    <td><?php echo e($i); ?></td>
                    <td><?php echo e($building->name); ?></td>
                    <td><?php echo e($guard && $guard->block ? $guard->block->name : '-'); ?></td>
                    <td><?php echo e($guard && $guard->gate ? $guard->gate->name : '-'); ?></td>
                    <td><img src="<?php echo e($bu->user->photo ?? ''); ?>" style="width:40px"></td>
                    <td><?php echo e($bu->user->name ?? ( ($bu->user->first_name ?? '') . ' ' . ($bu->user->last_name ?? '') )); ?></td>
                    <td><?php echo e($bu->user->phone ?? ''); ?></td>
                    <td><?php echo e($bu->user->email ?? ''); ?></td>
                    <td><?php echo e($bu->user->gender ?? ''); ?></td>
                    <td><?php echo e($bu->user->company_name ?? ''); ?></td>
                    <td><?php echo e($guard ? $guard->shift : '-'); ?></td>
                    <td><?php echo e($bu->status); ?></td>
                       <?php if(Auth::User()->role == 'BA'): ?>
                    <td>
                   <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'security')): ?>
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($guard->id); ?>" data-building_id="<?php echo e($guard->building_id); ?>" 
                          data-block_id="<?php echo e($guard->block_id); ?>" data-gate_id="<?php echo e($guard->gate_id); ?>" data-shift="<?php echo e($guard->shift); ?>" data-user_email="<?php echo e($bu->user->email); ?>" 
                          data-user_id="<?php echo e($bu->user->id); ?>" data-user_name="<?php echo e($bu->user->name ?? $bu->user->first_name); ?>" data-company_name="<?php echo e($bu->user->company_name); ?>" data-status="<?php echo e($bu->status); ?>"><i class="fa fa-edit"></i></button>
                      ...
                      <?php else: ?>
                       ...
                       <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'security')): ?>
                        <button class="btn btn-sm btn-success" data-toggle="modal" data-target="#addModal" 
                          data-user_email="<?php echo e($bu->user->email); ?>" data-user_name="<?php echo e($bu->user->name ?? $bu->user->first_name); ?>" data-user_id="<?php echo e($bu->user->id); ?>">
...
<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo e(url('store-new-guard')); ?>" method="post" class="add-user-form">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/guard/index.blade.php ENDPATH**/ ?>