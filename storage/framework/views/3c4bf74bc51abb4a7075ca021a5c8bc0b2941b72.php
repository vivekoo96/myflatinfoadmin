...
$(document).ready(function(){
    ...
    $(function () {
        $(".table").DataTable({
          "responsive": false, "ordering": true, "lengthChange": false, "autoWidth": false,"bPaginate": true,"bInfo": false,"searching": true,"pageLength": parseInt("<?php echo e($setting->pagination); ?>"),
          order: [[0, 'asc']],
          buttons: [
            {
                extend: 'csvHtml5',
...
<?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/layouts/nosidebar.blade.php ENDPATH**/ ?>