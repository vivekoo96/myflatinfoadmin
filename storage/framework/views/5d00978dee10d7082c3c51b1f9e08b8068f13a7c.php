          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo e($gate->name); ?></h3>
                </div>
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Building</b> <a class="float-right"><?php echo e($gate->building->name); ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Block</b> <a class="float-right"><?php echo e($gate->block->name); ?></a>
                  </li>
                  <li class="list-group-item">
                    <b>Flats</b> <a class="float-right"><?php echo e($gate->guards->count()); ?></a>
                  </li>
                ...
                <div class="tab-content">
                  <div class="active tab-pane" id="flats">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        <?php $i = 0; ?>
                        <?php $__empty_1 = true; $__currentLoopData = $gate->guards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guard): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php $i++ ?>
                        <tr>
                          <td><?php echo e($i); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/gate/show.blade.php ENDPATH**/ ?>