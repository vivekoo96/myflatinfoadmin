              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo e($event->is_payment_enabled); ?></td>
                ...
                <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'Accounts')): ?>
                        <td>
                          ...
                          data-from_time="<?php echo e(date('Y-m-d\TH:i', strtotime($event->from_time))); ?>" data-to_time="<?php echo e(date('Y-m-d\TH:i', strtotime($event->to_time))); ?>" data-status="<?php echo e($event->status); ?>" data-building_id="<?php echo e($event->building_id); ?>" data-is_payment_enabled="<?php echo e($event->is_payment_enabled); ?>"><i class="fa fa-edit"></i></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/event/index.blade.php ENDPATH**/ ?>