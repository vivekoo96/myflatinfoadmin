...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><?php echo e($building->name); ?> :
                  <?php
                        use App\Models\Role;
            ...
            <span><?php echo e($displayRole); ?></span>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(url('/')); ?>" class="brand-link text-center">
        ...
        <img src="<?php echo e($setting->logo); ?>" alt="<?php echo e($setting->bussiness_name); ?> Logo" class="brand-image" style="width:90%; height:auto; max-height:80px; object-fit:contain; display:inline-block; margin:10px auto; float:none;">
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          ?>
          <li class="nav-item">
            <a href="<?php echo e(url('/dashboard')); ?>" class="nav-link <?php echo e(request()->is('dashboard*') ? 'active' : ''); ?>" <?php echo e(getAccessControl($hasDashboardAccess)); ?>>
          ...
          ?>
             ...
             <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'President') || Auth::User()->hasPermission('custom.information')): ?>
          <li class="nav-item has-treeview <?php echo e($isInformationOpen ? 'menu-open' : ''); ?>">
              <a href="#" class="nav-link <?php echo e($isInformationOpen ? 'active' : ''); ?>" <?php echo e(getAccessControl($hasInformationAccess)); ?>>
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item">
                      <a href="<?php echo e(url('users')); ?>" class="nav-link <?php echo e($isUsersOpen ? 'second-active' : ''); ?>" <?php echo e(getAccessControl($hasUsersAccess)); ?>>
                          <i class="far fa-circle nav-icon"></i>
                          <p>Users</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?php echo e(url('other-users')); ?>" class="nav-link <?php echo e($isOtherUsersOpen ? 'second-active' : ''); ?>" <?php echo e(getAccessControl($hasUsersAccess)); ?>>
                          <i class="far fa-circle nav-icon"></i>
                          <p>Other Users</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?php echo e(route('block.index')); ?>" class="nav-link <?php echo e($isBlockActive ? 'second-active' : ''); ?>" <?php echo e(getAccessControl($hasBlockAccess)); ?>>
                          <i class="far fa-circle nav-icon"></i>
                          <p>Block</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?php echo e(route('flat.index')); ?>" class="nav-link <?php echo e($isFlatActive ? 'second-active' : ''); ?>" <?php echo e(getAccessControl($hasFlatAccess)); ?>>
                          <i class="far fa-circle nav-icon"></i>
                          <p>Flat</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?php echo e(route('gate.index')); ?>" class="nav-link <?php echo e($isGateActive ? 'second-active' : ''); ?>" <?php echo e(getAccessControl($hasGateAccess)); ?>>
                          <i class="far fa-circle nav-icon"></i>
                          <p>Gate</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?php echo e(route('parking.index')); ?>" class="nav-link <?php echo e($isParkingActive ? 'second-active' : ''); ?>" <?php echo e(getAccessControl($hasParkingAccess)); ?>>
                          <i class="far fa-circle nav-icon"></i>
                          <p>Parking</p>
                      </a>
                  </li>
    ...
    <?php endif; ?>
        ...
        ?>
              <?php if($role == 'Accounts' || Auth::User()->role == 'BA' || $role == 'President' || Auth::User()->hasPermission('custom.statements') || Auth::User()->hasPermission('custom.forms') || Auth::User()->hasPermission('custom.maintenances') || Auth::User()->hasPermission('custom.events') || Auth::User()->hasPermission('custom.essentials')): ?>
          <li class="nav-item has-treeview <?php echo e($isAccountOpen ? 'menu-open' : ''); ?>">
              <a href="#" class="nav-link <?php echo e($isAccountOpen ? 'active' : ''); ?> <?php echo e(getAccessControl($hasAccountsAccess)); ?>">
              ...
              ?>
               <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'Accounts') || $role == 'President' ): ?>
              <ul class="nav nav-treeview second">
                  <li class="nav-item">
                   <a href="<?php echo e(url('account/opening-balance')); ?>" class="nav-link <?php echo e(request()->is('account/opening-balance*') ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasStatementsAccess)); ?>">
    ...
    <li class="nav-item">
        <a href="<?php echo e(url('account/pending-bills')); ?>" 
           class="nav-link <?php echo e($isPendingBillsActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasStatementsAccess)); ?>">
            ...
            <p>Pending Bills</p>
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item has-treeview <?php echo e($isStatementOpen ? 'menu-open' : ''); ?>">
                      <a href="#" class="nav-link <?php echo e($isStatementOpen ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasStatementsAccess)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>
                              Statements
                              <i class="right fas fa-angle-left"></i>
                      ...
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(url('account/statement/income-and-expenditure')); ?>" class="nav-link <?php echo e($isIncomeActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasStatementsAccess)); ?>">
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item has-treeview <?php echo e($isFormOpen ? 'menu-open' : ''); ?>">
                      <a href="#" class="nav-link <?php echo e($isFormOpen ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasFormsAccess)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>
                              Forms
                              <i class="right fas fa-angle-left"></i>
                      ...
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(url('account/forms/payment')); ?>" class="nav-link <?php echo e($isPaymentActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasFormsAccess)); ?>">
                                <p>Payments</p>
                              </a>
                          </li>
                      </ul>
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(url('account/forms/reciept')); ?>" class="nav-link <?php echo e($isRecieptActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasFormsAccess)); ?>">
                                <p>Receipts</p>
                              </a>
                          </li>
                      </ul>
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item has-treeview <?php echo e($isMaintenanceOpen ? 'menu-open' : ''); ?>">
                      <a href="#" class="nav-link <?php echo e($isMaintenanceOpen ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasMaintenanceAccess && $hasMaintenanceFeature)); ?>">
                        <i class="far fa-circle nav-icon"></i>
                          <p>
                              Maintenance
                              <i class="right fas fa-angle-left"></i>
                      ...
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(route('maintenance.index')); ?>" class="nav-link <?php echo e($isGenerateActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasMaintenanceAccess && $hasMaintenanceFeature)); ?>">
                                <p>Generate</p>
                              </a>
                          </li>
                      </ul>
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(url('account/maintenance/manage')); ?>" class="nav-link <?php echo e($isManageActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasMaintenanceAccess && $hasMaintenanceFeature)); ?>">
                                <p>Manage</p>
                              </a>
                          </li>
                      </ul>
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item has-treeview <?php echo e($isContributionOpen ? 'menu-open' : ''); ?>">
                      <a href="#" class="nav-link <?php echo e($isContributionOpen ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasContributionsAccess)); ?>">
                        <i class="far fa-circle nav-icon"></i>
                          <p>
                              Contributions
                              <i class="right fas fa-angle-left"></i>
                      ...
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(route('event.index')); ?>" class="nav-link <?php echo e($isEventActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasContributionsAccess && $hasEventFeature)); ?>">
                                <p>Event</p>
                              </a>
                          </li>
                      </ul>
                      ...
                      <ul class="nav nav-treeview third">
                          <li class="nav-item">
                              <a href="<?php echo e(route('essential.index')); ?>" class="nav-link <?php echo e($isEssentialActive ? 'third-active' : ''); ?> <?php echo e(getAccessControl($hasContributionsAccess && $hasEssentialFeature)); ?>">
                                <p>Essential</p>
                              </a>
                          </li>
                      </ul>
    ...
    $role = Auth::user()->selectedRole->name ?? null;
        ...
        <?php if(
            ...
            <?php if($role !== 'Facility'): ?> 
                <!-- SHOW MENU -->
                <li class="nav-item has-treeview <?php echo e($isIssueManagementOpen ? 'menu-open' : ''); ?>">
                    <a href="#" class="nav-link <?php echo e($isIssueManagementOpen ? 'active' : ''); ?> <?php echo e(getAccessControl($hasIssueManagementAccess)); ?>">
                    ...
                    <ul class="nav nav-treeview second">
                         <li class="nav-item">
                            <a href="<?php echo e(url('issue-department')); ?>" class="nav-link <?php echo e($isRoleActive ? 'active' : ''); ?> <?php echo e(getAccessControl($hasIssueDepartmentAccess && $hasStaffFeature)); ?>">
                                <i class="nav-icon fa fa-exclamation-triangle"></i>
                                <p>Issue Departments</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo e(route('issue.index')); ?>" class="nav-link <?php echo e($isIssueOpen ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasIssueManagementAccess && $hasIssueFeature)); ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Issue Tracking</p>
                            </a>
                        </li>
          ...
          ?>
           <?php if($user->role == 'BA' || Auth::User()->selectedRole->name == 'Facility' || Auth::User()->selectedRole->name == 'President' || Auth::User()->hasPermission('custom.facilities') || Auth::User()->hasPermission('custom.bookings')): ?>
          <li class="nav-item has-treeview <?php echo e($isAmenitiesManagementOpen ? 'menu-open' : ''); ?>">
              <a href="#" class="nav-link <?php echo e($isAmenitiesManagementOpen ? 'active' : ''); ?> <?php echo e(getAccessControl($hasAmenitiesAccess)); ?>">
                  <i class="nav-icon fa fa-server"></i>
                  <p>
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item">
                      <a href="<?php echo e(route('facility.index')); ?>" class="nav-link <?php echo e($isFacilityActive ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasAmenitiesAccess && $hasFacilityFeatureAccess)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Facility</p>
                      </a>
                  </li>
                  <li class="nav-item">
                      <a href="<?php echo e(route('booking.index')); ?>" class="nav-link <?php echo e($isBookingActive ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasAmenitiesAccess && $hasFacilityFeatureAccess)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Bookings</p>
                      </a>
                  </li>
          ...
          ?>
           <?php if($user->role == 'BA' || Auth::User()->selectedRole->name == 'President' || Auth::User()->hasPermission('custom.roles')): ?>
          <li class="nav-item has-treeview <?php echo e($isStaffOpen ? 'menu-open' : ''); ?>">
              <a href="#" class="nav-link <?php echo e($isStaffOpen ? 'active' : ''); ?> <?php echo e(getAccessControl($hasRoleManagementAccess && $hasStaffFeature)); ?>">
              ...
              <ul class="nav nav-treeview second">
                  <?php $__empty_1 = true; $__currentLoopData = Auth::User()->building->common_roles(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <li class="nav-item">
                    <a href="<?php echo e(url('department',$role->slug)); ?>" class="nav-link <?php echo e(request()->is('department/'.$role->slug.'*') ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasRoleManagementAccess && $hasStaffFeature)); ?>">
                      <i class="nav-icon fas fa-duotone fa-user"></i>
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(url('custom-departments')); ?>" class="nav-link <?php echo e(request()->is('custom-departments*') ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasRoleManagementAccess && $hasStaffFeature)); ?>">
                      <i class="nav-icon fas fa-duotone fa-user"></i>
                      <p>Custom Roles</p>
                    </a>
                  </li>
          ...
          ?>
            <?php if($user->role == 'BA' || Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'Security' || Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'President' || Auth::User()->hasPermission('custom.visitors') || Auth::User()->hasPermission('custom.vehicles') || Auth::User()->hasPermission('custom.vehiclesinouts')): ?>
          <li class="nav-item has-treeview <?php echo e($isVehicleOpen ? 'menu-open' : ''); ?>">
              <a href="#" class="nav-link <?php echo e($isVehicleOpen ? 'active' : ''); ?> <?php echo e(getAccessControl($hasSecurityManagementAccess && $hasVehicleFeature)); ?>">
              ...
              <ul class="nav nav-treeview second">
                  <li class="nav-item">
                      <a href="<?php echo e(route('visitor.index')); ?>" class="nav-link <?php echo e($isVisitorActive ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasVisitorsAccess && $hasVehicleFeature)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Visitors</p>
                      </a>
                  </li>
                  ...
                  <li class="nav-item">
                      <a href="<?php echo e(route('vehicles.index')); ?>" class="nav-link <?php echo e($isVehicleActive ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasVehiclesAccess && $hasVehicleFeature)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Vehicles</p>
                      </a>
                  </li>
                  ...
                  <li class="nav-item">
                      <a href="<?php echo e(url('vehicle-inouts')); ?>" class="nav-link <?php echo e($isInoutActive ? 'second-active' : ''); ?> <?php echo e(getAccessControl($hasVehiclesAccess && $hasVehicleFeature)); ?>">
                          <i class="far fa-circle nav-icon"></i>
                          <p>Vehicle Inouts</p>
                      </a>
                  </li>
                   <li class="nav-item">
            <a href="<?php echo e(url('guard')); ?>" class="nav-link <?php echo e(request()->is('guard*') ? 'active' : ''); ?> <?php echo e(getAccessControl($hasSecurityGuardAccess && $hasStaffFeature)); ?>">
              <i class="nav-icon fa fa-shield"></i>
              <p>Security Guard</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('security-notes.index')); ?>" class="nav-link <?php echo e(request()->is('security-notes*') ? 'active' : ''); ?> <?php echo e(getAccessControl($hasSecurityGuardAccess && $hasStaffFeature)); ?>">
          ...
          ?>
        <?php if($user->role == 'BA' || Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'President' || Auth::User()->hasPermission('custom.noticeboards')): ?>
          <li class="nav-item">
            <a href="<?php echo e(route('noticeboard.index')); ?>" class="nav-link <?php echo e(request()->is('noticeboard*') ? 'active' : ''); ?> <?php echo e(getAccessControl($hasNoticeBoardAccess && $hasNoticeBoardFeature)); ?>">
        ...
        <?php endif; ?>
          ...
          ?>
          <?php if($user->role == 'BA'): ?>
          <li class="nav-item <?php echo e(request()->is('notification*') ? 'menu-open' : ''); ?>">
            <a href="#" class="nav-link <?php echo e(request()->is('notification*') ? 'active' : ''); ?> <?php echo e(getAccessControl($hasNotifFeature)); ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo e(route('notification.index')); ?>" class="nav-link <?php echo e(request()->routeIs('notification.index') ? 'active' : ''); ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Create Notification</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo e(route('notification.history')); ?>" class="nav-link <?php echo e(request()->routeIs('notification.history') ? 'active' : ''); ?>">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <?php if($user->role == 'BA' || Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'President' || Auth::User()->hasPermission('custom.classifieds')): ?>
          <li class="nav-item">
          ...
          <!--<?php if($user->role == 'BA' || $user->hasRole('president') || $user->hasRole('accounts') || $user->hasPermission('feature.societyfund')): ?>-->
          <!--<li class="nav-item">-->
       ...
       <?php if($user->role == 'BA'): ?>
          ...
          <?php if($user->role == 'BA' || $user->hasRole('president') || $user->hasRole('accounts')): ?>
          <!--<li class="nav-item">-->
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('building-policy')); ?>" class="nav-link <?php echo e(request()->is('building-policy') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-sharp fa-solid fa-fill"></i>
              <p>Building Policy</p>
            </a>
          </li>
...
<?php if($user->role == 'BA' || Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'President'): ?>
         
                    <li class="nav-item">
                        <a href="<?php echo e(url('/terms-conditions')); ?>" class="nav-link">
                            <i class="nav-icon fas fa-file-contract"></i>
                            <p>Terms & Conditions</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(url('/privacy-policy')); ?>" class="nav-link">
                            <i class="nav-icon fas fa-user-secret"></i>
                            <p>Privacy Policy</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(url('/cancellation-policy')); ?>" class="nav-link">
...
$(document).ready(function(){
        $(".table").DataTable({
          ...
          "info": false,
          "searching": true,
          "pageLength": parseInt("<?php echo e($setting->pagination); ?>"),
          "language": {
              "search": "Search:"
          },
          order: [[0, 'asc']],
...
<?php /**PATH C:\Users\vvive\Herd\myflatinfos\admin\resources\views/layouts/admin.blade.php ENDPATH**/ ?>