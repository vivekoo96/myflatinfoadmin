...
<body>
    <div class="container">
        ...
        <p class="forgot-subtitle">Enter your email address to receive an OTP reset link.</p>
        ...
        <div class="form-container">
            ...
            <form method="post" action="<?php echo e(url('forget-password')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="reset_method" value="otp">
                ...
                <button type="submit" class="submit-btn">Send Reset Request</button>
            </form>
        </div>
...
</html><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/forgot_password.blade.php ENDPATH**/ ?>