...
<head>
    ...
    <title>Verify OTP | <?php echo e($setting->bussiness_name); ?></title>
    ...
    <style>
        * {
        ...
        body {
            ...
            background: url('<?php echo e(asset("/public/admin/ChatGPT Image Nov 15_ 2025_ 04_23_23 PM.png")); ?>') no-repeat center center fixed;
        ...
        <div class="form-container">
            ...
            <form method="post" action="<?php echo e(url('verify-otp')); ?>">
                ...
                <?php if($errors->has('otp')): ?>
                    <div class="error-text"><?php echo e($errors->first('otp')); ?></div>
                <?php endif; ?>
            ...
            <div>
                ...
                <a href="<?php echo e(url('resend-otp?email=' . $email)); ?>" class="resend-link">Resend OTP</a>
            </div>
        </div>
        
        <a href="<?php echo e(url('forget-password')); ?>" class="back-link">Back to Forgot Password</a>
    </div>
...
<?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/verify_otp.blade.php ENDPATH**/ ?>