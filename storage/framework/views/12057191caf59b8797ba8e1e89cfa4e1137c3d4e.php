              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo e($maintenance->vacant_amount); ?></td>
                    ...
                    <td><?php echo e($maintenance->gst); ?></td>
                    ...
                    <td>
                      <!--<a href="<?php echo e(route('maintenance.show',$maintenance->id)); ?>" target="_blank"  class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>-->
                       <?php if(Auth::User()->role == 'BA' || (Auth::User()->selectedRole && Auth::User()->selectedRole->name == 'Accounts')): ?>
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($maintenance->id); ?>" data-from_date="<?php echo e($maintenance->from_date); ?>" data-maintenance_type="<?php echo e($maintenance->maintenance_type); ?>" data-vacant_amount="<?php echo e($maintenance->vacant_amount); ?>"
                      data-to_date="<?php echo e($maintenance->to_date); ?>" data-building_id="<?php echo e($maintenance->building_id); ?>" data-amount="<?php echo e($maintenance->amount); ?>" data-status="<?php echo e($maintenance->status); ?>" data-gst="<?php echo e($maintenance->gst); ?>" 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/myflatin/buildingadmin.myflatinfo.com/resources/views/admin/maintenance/index.blade.php ENDPATH**/ ?>