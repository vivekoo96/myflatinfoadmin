...
// Route::prefix('customer')->group(function () {
    ...
    Route::post('get-notifications',[CustomerController::class,'get_notifications']);
      ...
      Route::post('clear-all-notifications-user',[CustomerController::class,'clear_all_notifications_user']);
        ...
        Route::post('get-my-move-request-details', [MoveInOutApiController::class, 'get_my_move_request_details']);
      ...
      Route::post('get-issue-comments-user',[CustomerController::class,'get_issue_comments_user']);
        ...
        Route::post('get-tokenData',[CustomerController::class,'get_tokenData']);
            ...
            Route::post('flat-staff-checkin-out', [App\Http\Controllers\Api\StaffApiController::class, 'flatStaffCheckInOut']);
            Route::post('get-flat-staff-logs', [App\Http\Controllers\Api\StaffApiController::class, 'getFlatStaffLogs']);
            Route::post('get-staff-data', [App\Http\Controllers\Api\StaffApiController::class, 'getStaffData']);
            ...
            Route::post('get-building-domestic-staff', [App\Http\Controllers\Api\StaffApiController::class, 'getBuildingDomesticStaff']);
            Route::post('tag-flat-emp', [App\Http\Controllers\Api\StaffApiController::class, 'tagFlatEmp']);
        ...
        Route::post('guard/submit-takeover',          [App\Http\Controllers\Api\GuardShiftController::class, 'submitTakeover']);
